 ...
 * define
 */
#define		SERVER_DEVICE_VERSION_STRING		"alpha-8.0.4"
...
#define		MSG_DEVICE_PROPERTY_GET				MSG_DEVICE_BASE | 0x0013
#define		MSG_DEVICE_PROPERTY_GET_ACK			MSG_DEVICE_BASE | 0x1013
