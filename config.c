...
static config_map_t device_config_map[] = {
	...
	{"led1_gpio_mcu",      			&(device_config.led1_gpio_mcu),   			cfg_u32,		"0",0,0,100,},
	{"led1_effect_level",      		&(device_config.led1_effect_level),   		cfg_u32,		"1",0,0,100,},
	{"led2_gpio",      				&(device_config.led2_gpio),   				cfg_u32,		"22",0,0,100,},
	{"led2_gpio_mcu",      			&(device_config.led2_gpio_mcu),   			cfg_u32,		"0",0,0,100,},
	{"led2_effect_level",      		&(device_config.led2_effect_level),   		cfg_u32,		"1",0,0,100,},
	{"spk_gpio",      				&(device_config.spk_gpio),   				cfg_u32,		"11",0,0,100,},
	{"spk_gpio_mcu",      			&(device_config.spk_gpio_mcu),   			cfg_u32,		"1",0,0,100,},
	{"spk_effect_level",      		&(device_config.spk_effect_level),   		cfg_u32,		"1",0,0,100,},
	{"ircut_ain",      				&(device_config.ircut_ain),   				cfg_u32,		"16",0,0,100,},
	{"ircut_ain_mcu",      			&(device_config.ircut_ain_mcu),   			cfg_u32,		"0",0,0,100,},
	{"ircut_a_effect_level",      	&(device_config.ircut_a_effect_level),   	cfg_u32,		"1",0,0,100,},
	{"ircut_bin",      				&(device_config.ircut_bin),   				cfg_u32,		"17",0,0,100,},
	{"ircut_bin_mcu",      			&(device_config.ircut_bin_mcu),   			cfg_u32,		"0",0,0,100,},
	{"ircut_b_effect_level",      	&(device_config.ircut_b_effect_level),   	cfg_u32,		"1",0,0,100,},
	{"irled",      					&(device_config.irled),   					cfg_u32,		"6",0,0,100,},
	{"irled_mcu",      				&(device_config.irled_mcu),   				cfg_u32,		"0",0,0,100,},
	{"irled_effect_level",      	&(device_config.irled_effect_level),   		cfg_u32,		"1",0,0,100,},
	{"motor_595enable",      		&(device_config.motor_595enable),   		cfg_u32,		"0",0,0,100,},
	{"motor_595enable_mcu",      	&(device_config.motor_595enable_mcu),   	cfg_u32,		"0",0,0,100,},
	{"moto_595_effect_level",      	&(device_config.moto_595_effect_level),   	cfg_u32,		"0",0,0,100,},
